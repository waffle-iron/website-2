    <div id="footer">
        ...
        <div class="container">
            ...
            <div id="footer_browse" class="footer_info">
                ...
                <h4>Magazines</h4>
                <ul>
                    <li><a href="<?= $config['site_url'] ?>/magazine/november14.php">November 2014</a></li>
                    <li><a href="<?= $config['site_url'] ?>/magazine/october14.php">October 2014</a></li>
                </ul>
            ...
            <a href="index.html" id="footer_logo">
                <img src="<?= $config['image_url']; ?>/logo_phpreboot_100.png" height="35">
            </a>
